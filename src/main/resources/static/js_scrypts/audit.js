...
const AUDIT_EVENTS = [
    ...
    { value: "USER_CREATED_SUCCESS", label: "Успешное создание пользователя" },
    { value: "USER_CREATED_FAIL", label: "Неуспешное создание пользователя" },
    ...
    { value: "USER_EDITED_SUCCESS", label: "Успешное изменение пользователя" },
    { value: "USER_EDITED_FAIL", label: "Неуспешное изменение пользователя" },
